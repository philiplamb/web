            ...
            <GuestLayout>
                <main className="container mx-auto px-11">
                    <section className="py-10 md:py-32 md:w-2/3">
                        <h1 className="text-3xl md:text-5xl font-bold mb-2">Learn about me in    e-Learning format</h1>
